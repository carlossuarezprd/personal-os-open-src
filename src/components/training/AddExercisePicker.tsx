...
const styles: Record<string, React.CSSProperties> = {
  ...
  crumb: { fontSize: '13px', color: 'var(--teal)', fontWeight: 600 },
  crumbSep: { color: 'var(--text-mid)', fontSize: '13px' },
  stepTitle: { fontSize: '18px', fontWeight: 700, color: 'var(--text-hi)' },
  search: { padding: '9px 12px', borderRadius: 'var(--r-chip)', fontSize: '15px', width: '100%', marginBottom: '4px' },
  ...
  createBtn: { padding: '9px 16px', background: 'var(--teal)', color: 'var(--bg-0)', fontWeight: 600, borderRadius: 'var(--r-pill)', fontSize: '14px' },
  createTrigger: { padding: '12px 14px', color: 'var(--teal)', fontSize: '14px', fontWeight: 600, textAlign: 'left' },
  prevMax: { fontSize: '12px', color: 'var(--blue)', marginTop: '2px', fontWeight: 500 },
};
