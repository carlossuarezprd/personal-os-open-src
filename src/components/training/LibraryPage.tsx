...
const styles: Record<string, React.CSSProperties> = {
  ...
  search: { padding: '9px 12px', borderRadius: 'var(--r-chip)', fontSize: '14px', width: '100%' },
  ...
  groupHeader: { fontSize: '12px', fontWeight: 700, color: 'var(--text-mid)', textTransform: 'uppercase', letterSpacing: '0.08em' },
  card: {
    position: 'relative',
    padding: '12px 14px',
  ...
  cardName: { fontSize: '15px', color: 'var(--text-hi)', fontWeight: 600 },
  cardMax: { fontSize: '12px', color: 'var(--blue)', marginTop: '2px' },
  cardEmpty: { fontSize: '12px', color: 'var(--text-mid)', marginTop: '2px' },
  chevron: { position: 'absolute', right: '14px', top: '50%', transform: 'translateY(-50%)', fontSize: '18px', color: 'var(--text-mid)' },
