...
const styles: Record<string, React.CSSProperties> = {
  page: { padding: 24, maxWidth: 720, color: 'var(--text)' },
  ...
  body: { color: 'var(--text-muted)', fontSize: 14, lineHeight: 1.5, marginBottom: 16 },
  ...
  summaryList: { listStyle: 'none', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6 },
};
